...
CREATE TABLE application_nonces (
  applicationID varchar(255) NOT NULL,
  nonce varchar(255) NOT NULL,
  PRIMARY KEY (applicationID,nonce)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE groups (
  ...
  `type` enum('open','closed','private','secret') NOT NULL DEFAULT 'secret',
...
ALTER TABLE `access_grants`
  ADD CONSTRAINT access_grants_ibfk_1 FOREIGN KEY (userID) REFERENCES `users` (userID) ON DELETE CASCADE;
