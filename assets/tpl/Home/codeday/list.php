...
<div class="row">
    <div class="span12 box">
        ...
        <table class="table table-striped table-condensed">
            ...
            <?php foreach ($events as $event) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn" href="<?=\CuteControllers\Router::link('/codeday/manage?eventID=' . $event->eventID)?>">
                            Edit Event Details
                        </a>
                        <?php if (\StudentRND\My\Models\User::current()->is_admin) : ?>
                            <a class="btn" href="<?=\CuteControllers\Router::link('/codeday/admin/update?eventID=' . $event->eventID)?>">
                                Edit Event Config
                            </a>
                        <?php endif ?>
                    </td>
        ...
        <?php if (\StudentRND\My\Models\User::current()->is_admin) : ?>
            <a class="btn" href="<?=\CuteControllers\Router::link('/codeday/admin/create')?>">
                New Event
            </a>
        <?php endif ?>
    </div>
