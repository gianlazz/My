    ...
    <?php if ($this->user->has_group(new \StudentRND\My\Models\Group(10))) : ?>
        <div class="row">
            <div class="span12 alert alert-info">
                ...
                <p>Make sure you're aware of the <a href="http://wiki.studentrnd.org/Key_Holder" target="_blank">keyholder rights and responsibilities</a>!</p>
            </div>
        </div>
            ...
            <?php if (\StudentRND\My\Models\User::current()->studentrnd_email_enabled) : ?>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?=\CuteControllers\Router::link('/resources/google_apps/login/mail')?>" target="_new">Mail</a></li>
                        <li><a href="<?=\CuteControllers\Router::link('/resources/google_apps/login/calendar')?>" target="_new">Calendar</a></li>
                        <li><a href="<?=\CuteControllers\Router::link('/resources/google_apps/login/drive')?>" target="_new">Drive</a></li>
                        <li class="divider"></li>
                        <li><a href="<?=\CuteControllers\Router::link('/resources/google_apps/settings')?>" target="_new">Settings</a></li>
                        <?php if (\StudentRND\My\Models\User::current()->is_admin) : ?>
                            <li><a href="<?=\CuteControllers\Router::link('/resources/google_apps/login/www')?>" target="_new">Admin</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            <?php endif; ?>
            <?php if (count($this->user->groups) > 0) : ?>
                <a class="btn btn-block btn-xlarge" href="<?=\CuteControllers\Router::link('/resources/dreamspark/login')?>" target="_new">Dreamspark Premium</a>
            <?php endif; ?>
            <a class="btn btn-block btn-xlarge" href="<?=\CuteControllers\Router::link('http://wiki.studentrnd.org/')?>" target="_new">Wiki</a>
        </div>
    </div>
