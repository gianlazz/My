        ...
        <div class="span5 well">
            ...
            <ul class="groupslist">
                <?php foreach ($this->user->groups as $group) : ?>
                    ...
                    <li class="in"><a href="<?=\CuteControllers\Router::link('/groups/page?group=' . $group->groupID)?>"><?=$group->name?></a></li>
                <?php endforeach; ?>
            </ul>
            <br class="clearfix" />
        </div>
        ...
        <div class="span6 box">
            ...
            <ul class="groupslist">
                <?php foreach ($visible_groups as $group) : ?>
                    ...
                    ><a href="<?=\CuteControllers\Router::link('/groups/page?group=' . $group->groupID)?>"><?=$group->name?></a></li>
                <?php endforeach; ?>
            </ul>
            <br class="clearfix" />
        </div>
