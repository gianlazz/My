...
<head>
    ...
    <link rel="image_src" href="http://oldwww.studentrnd.org/images/cubes.gif" />
        ...
        ">
          ...
          <p><?=$this->current_codeday->tagline?></p><br/><br/>
            ...
            <?php elseif ($this->current_codeday->is_presale) : ?>
                <a href="<?=\CuteControllers\Router::link('/register.html');?>" class="btn btn-primary btn-large" style="text-decoration:none">Register Today!</a>
            <?php endif; ?>
