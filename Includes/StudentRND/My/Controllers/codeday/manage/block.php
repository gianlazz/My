...
class Block extends \CuteControllers\Base\CrudFormController
{
    public static $template = '';
    public static $model = '\StudentRND\My\Models\CodeDay\Block';
...
Block::$template = TEMPLATE_DIR . '/Home/codeday/form.php';
