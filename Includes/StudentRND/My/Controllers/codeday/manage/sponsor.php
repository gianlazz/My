...
class Sponsor extends \CuteControllers\Base\CrudFormController
{
    public static $template = '';
    public static $model = '\StudentRND\My\Models\CodeDay\Sponsor';
...
Sponsor::$template = TEMPLATE_DIR . '/Home/codeday/form.php';
